...
#seems like the first section of code (pivot_longer) makes a clean set by itself and then the pivot_wider gets you information you want all together, but makes it messier again (data in the labels). i might be misunderstanding the goal and data though
