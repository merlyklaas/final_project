...
pacman::p_load(tidyverse, rio, here, ggridges, ggthemes, skimr, janitor, reshape2, psych,jtools, lme4, sjPlot, performance, sjmisc, gtsummary, car, lm.beta, ggplot2, Hmisc, ppcor, dplyr, tidyr, readr, tinytex, crayon, naniar, magrittr) 
...
theme(text = element_text(size = 30, face = "bold"),
        axis.text.x = element_text(angle = 90, hjust = 1))
ggsave(here("plot", "multoos_k12.jpg"))
```
