...
#Recommend adding something to this code's settings to prevent all the "changed values" messages from appearing.
...
```
It looks like you are filtering out most of your data — is that intentional?
...
data_join %>%
  ...
  select(
         ...
         `Hawaiaan and Pacific Islander Students Enrollment (%)` = sch_enr_hp,
...
The two graphs of Suspensions rate by Ethnicity show that __Black Students__ were suspended more compared to their peers in Preschool and K-12. When gender was included in the third and fourth graphs, they also show that both __Black Male__ and __Black Female__ students were suspended more compared to their peers in Preschool and K-12. Overall, __Male__ students were suspended more than female students across all school level.
