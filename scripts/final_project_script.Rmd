...
pacman::p_load(tidyverse, rio, here, ggridges, ggthemes, skimr, tidylog, janitor, reshape2, psych,jtools, lme4, sjPlot) 
...
**Note: This section was written early during the term. We'll probably remove it for the final submission.**
